...
\section{Experience}
  ...
  {Purdue Vertically Integrated Projects}{West Lafayette, IN}
    \resumeItemListStart
      ...
      \resumeItem{Labelled and annotated data to train a machine learning model to predict chatter and other failures.}
    \resumeItemListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, C, Java, SQL (Postgres), R, LaTeX, x86-64 Assembly} \\
     \textbf{Developer Tools}{: Git, Bash, VS Code, Jupyter, PyCharm, IntelliJ, MTConnect, Agile Methodologies} \\
