...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{hirehack} $|$ \emph{Python, JavaScript, PyTorch, HuggingFace}}{Jan. 2024 - Present}
          \resumeItemListStart
            \resumeItem{Developed a Chrome extension to automatically analyze interviewee responses and provide real-time feedback.}
