    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Implemented a directed acyclic graph to represent computational graph of a neural network and perform backpropagation to calculate gradients.}
            ...
            \resumeItem{Utilized dynamic memory allocation to constantly allocate and free heap space for the graph during runtime for efficient memory usage.}
