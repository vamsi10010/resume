...
\section{Experience}
  ...
  \resumeSubheading{Software Development Engineer Intern}{May. 2025 -- Aug. 2025}
      ...
      \resumeItemListStart
        \resumeItem{Developed a cost tracing service with RESTful API to improve supply chain accounting for Project Kuiper.}
        \resumeItem{Deployed a scalable serverless data pipeline on AWS achieving sub-10ms queries on millions of cost events.}
        \resumeItem{Implemented an MCP agent using API Gateway endpoints, Neo4j, and Claude to enable natural language queries.}
      \resumeItemListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Bash, Linux, MacOS, LLVM, AWS, IaC, Docker, Gradle, Neo4j, MCP, REST API, uv} \\
