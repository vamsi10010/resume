...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\textit{Coursework}: OOP, Statistics, Data Structures and Algorithms, Computer Architecture,
        \\Systems Programming, Compilers, Machine Learning, AI, NLP, Robotics
        }
        % \resumeItem{\textit{Clubs and Extracurriculars}: ML@Purdue, Purdue Astronomy Club, Intramural Soccer}
        \resumeItem{\textit{Honors}: Dean's List and Semester Honors (5x), L3Harris Scholarship, UG Research Expo Poster Award}
        \resumeItem{\textit{GPA}: 3.99/4.0}
      \resumeItemListEnd
    % \resumeSubheading
