...
\section{Experience}
  ...
  \resumeSubheading{AI/ML Intern}{May. 2024 -- Present}
      ...
      \resumeItemListStart
        \resumeItem{Designed an end-to-end edge computer vision pipeline to track truck service on factory floor using YOLOv8n and PaddleOCR.
      ...
      \resumeItemListEnd
  \resumeSubheading{Undergraduate Teaching Assistant}{Aug. 2023 -- May. 2024}
