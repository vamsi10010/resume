...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Masters of Science in Computer Science}{\textit{GPA}: 3.96/4.0}
    \resumeSubheading
      {Purdue University}{Aug. 2022 -- May 2025}
      {Bachelor of Science in Computer Science}{\textit{GPA}: 3.99/4.0}
      \resumeItemListStart
        \resumeItem{\textit{Coursework}: OOP, DSA, Computer Architecture, Systems Programming, Compilers, AI, \\Parallel Computing, Networking, Randomized Algorithms, Deep Learning, NLP, ML Systems
        }
...
\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading{Graduate Teaching Assistant, Head TA}{Jan. 2026 -- Present}
      {Department of Computer Science, Purdue University}{West Lafayette, IN}
      \resumeItemListStart
        \resumeItem{Led a team of 8 developers to build homework infrastructure and testing systems for CS 240 (C Programming).}
        % \resumeItem{Implemented a comprehensive testing framework and grading suite in C for students' programming assignments.}
        \resumeItem{Automated repository creation and grading for 700+ students on Purdue's Linux servers using Bash and Git.}
        \resumeItem{Mentored TAs, managed development timelines, triaged issues, and ensured timely delivery of 13 assignments.}
      \resumeItemListEnd
  \resumeSubheading{Software Development Engineer Intern}{May 2025 -- Aug. 2025}
      {Amazon}{Redmond, WA}
      \resumeItemListStart
        \resumeItem{Developed a cost tracing service with RESTful API improving supply chain cost visibility for Amazon Leo.}
  ...
  \resumeSubheading{AI/ML Intern}{May 2024 -- Aug. 2024}
      ...
      \resumeItemListStart
        ...
        \resumeItem{Implemented a live web interface using Streamlit to monitor KPIs such as truck count and takt time on-site.}
  ...
  \resumeSubheading{Undergraduate Teaching Assistant}{Aug. 2023 -- May 2025}
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed C programming assignments and comprehensive grading suites to streamline course delivery.}
...
\section{Projects}
    ...
    {\textbf{codeminder} $|$ \emph{Python, PyTorch, LanceDB, Tree-sitter, FastMCP, RAG}}{Dec. 2025 - Present}
    \resumeItemListStart
      \resumeItem{Engineered a RAG system using LanceDB and Tree-sitter to power semantic code search for LLM agents.}
      \resumeItem{Implemented a novel AST embedding algorithm that reduced search scopes for coding agents by 73\%.}
      \resumeItem{Packaged into a Python library with Github actions and used FastMCP to enable seamless use with coding agents.}
    \resumeItemListEnd

    % \resumeProjectHeading
    % {\textbf{LLM Uncertainity Calibration} $|$ \emph{Python, PyTorch, HuggingFace, scikit-learn, LMDB}}{Mar. 2025 - May 2025}
    % \resumeItemListStart
    %   \resumeItem{Built an LLM calibration pipeline to quantify response uncertainty on real-world tasks during inference.}
    %   \resumeItem{Designed a rigorous scikit-learn evaluation suite to compute error metrics and generate calibration curves.}
    %   \resumeItem{Scaled experiments with LMDB tensor caching and batched GPU inference, speeding up experiments.}
    % \resumeItemListEnd
    ...
    %       \resumeItemListEnd
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed an LLM agent to automatically analyze interview performance through a Chrome extension.}
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{cgrad} $|$ \emph{C, C++, cmocka, Deep Learning}}{Aug. 2023 -- Sep. 2023}
          \resumeItemListStart
            ...
            \resumeItem{Implemented automatic differentiation, layers, activation functions, gradient descent, and regularization options.}
      ...
      %     \resumeItemListStart
      %       \resumeItem{Developed a college recommender system application to assist high school students in college search.}
      ...
      %       \resumeItem{Built and deployed web application and dashboard through Streamlit to make it accessible to users.}
      %     \resumeItemListEnd
      % \resumeProjectHeading
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Bash, UNIX, MPI, OpenMP, AWS, Azure, IaC, Docker, Neo4j, REST API, uv, Agile} \\
     \textbf{Libraries}{: PyTorch, HuggingFace, RayTune, Streamlit, Tensorflow, LLVM, LanceDB, FastMCP, Tree-sitter} \\
