  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Fine-tuned a BERT model from the HuggingFace library to accurately identify adverse drug events in electronic health records.}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Utilized dynamic memory allocation to allocate and free heap space during runtime for efficient memory usage.}
