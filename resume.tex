...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\textit{Coursework}: OOP, DSA, Computer Architecture, Systems Programming, Compilers, AI, \\Machine Learning, NLP, Robotics
        }
...
\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading{SDE Intern}{May. 2025 -- Aug. 2025}
      {Amazon, Project Kuiper}{Redmond, WA}
      \resumeItemListStart
        \resumeItem{Developed a cost tracing system with RESTful API endpoints to improve supply chain accounting for Kuiper.}
        \resumeItem{Deployed a scalable serverless data pipeline on AWS achieving sub-10ms queries on millions of cost events.}
        \resumeItem{Implemented an MCP agent using API Gateway and a Neo4j database to enable natural language queries.}
      \resumeItemListEnd
  \resumeSubheading{Undergraduate Teaching Assistant}{Aug. 2023 -- May 2025}
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed programming assignments and test frameworks to evaluate student understanding of course material.}
        \resumeItem{Enhanced student learning outcomes by conducting weekly lab sessions and office hours for 40+ students.}
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Bash, Linux, LLVM, ROS, MTConnect, XML, Azure DevOps, Thingworx, Agile Methodologies} \\
